        ...
        <div className="flex flex-wrap xl:flex-nowrap gap-10 xl:gap-19 xl:justify-between pt-17.5 xl:pt-22.5 pb-10 xl:pb-15">
          ...
          <div className="w-full sm:w-auto">
            ...
            <p className="lg:text-right text-custom-sm mb-4">
              Ahorra S/ 3 con la App y solo usuarios nuevos
            </p>
            ...
            <ul className="flex flex-col lg:items-end gap-3">
              ...
              <li>
                ...
                >
                  ...
                  <div>
                    <span className="block text-custom-xs"> Obtener en </span>
        ...
        <div className="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
          <div className="flex gap-5 flex-wrap items-center justify-between">
            <p className="text-dark font-medium">
              &copy; {year}. Todos los derechos reservados por Mercadillo Libre.
            </p>
